...
{
    public IQueryable<FormGridView> Find(string? orderBy = null, string? sortOrder = null, IEnumerable<string>? filters = null)
    {
        return base.FindByConditionDynamic(filters: filters, orderBy: orderBy, sortOrder: sortOrder);
    }
}
